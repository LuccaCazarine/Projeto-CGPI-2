...
class Gui extends JFrame {
    ...
    private JButton jbPoligonoFechado = new JButton("PoligonoFechado");
    ...
    public Gui(int larg, int alt) {
        ...
        barraComandos.add(jbPoligonoFechado);
        ...
        jbLinhaPoligonal.addActionListener(e -> {
            tipoAtual = TipoPrimitivo.LINHA_POLIGONAL;
            areaDesenho.setTipo(tipoAtual);
        });
        jbPoligonoFechado.addActionListener(e -> {
            tipoAtual = TipoPrimitivo.POLIGONO_FECHADO;
            areaDesenho.setTipo(tipoAtual);
        });
